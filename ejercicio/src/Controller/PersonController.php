...
class PersonController {
    ...
    */
    ...
    /**
    * Funcionalidad que se encarga de actualizar un usuario de una petición http.
    * Previa a la actualización, se valida que el usuario exista en la tabla.
    * Si es correcto, se inserta en la base de datos.
    * @param $id. 
    * @return Response
    */
    ...
    /**
    * Funcionalidad que se encarga de eliminar un usuario.
    * Previamente a la eliminación, se valida que el usuario exista en la tabla.
    * Si es correcto, se elimina de la base de datos.
    * @param $id int
    * @return Response
    */
    ...
    /**
    * Funcionalidad que se encarga de validar para que los campos no esten vacios??
    * 
    *
    * @param $input string
    * @return false
    ...
    */
    ...
    /**
    * Funcionalidad que se encarga de motrar que no se puede procesar la información solicitada por algun tipo de error en los datos.
    * Inserta el código 422 en la respuesta.
    * @return Response
    */
    ...
    /**
    * Funcionalidad que se encarga de mostrar que hay un error.
    * Inserta el código 404 en la respuesta.
    * @return Response
    */
